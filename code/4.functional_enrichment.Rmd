...
combined_with_inter_fun$go <- edgeR::goana.DGELRT(combined_de_with_interaction$lrt, 
                                   ...
                                   species = "Hs")
combined_with_inter_fun$top_go <- topGO(combined_with_inter_fun$go, sort="up", p.value = 0.05)
...
combined_with_inter_fun$kegg <- edgeR::kegga.DGELRT(combined_de_with_interaction$lrt, 
                                     geneid = combined_with_inter_fun$entrez_ids,
                                     species = "Hs")
combined_with_inter_fun$top_kegg <- topKEGG(combined_with_inter_fun$kegg, sort="up", p.value = 0.05)
...
# Plot the results
gprofiler2::gostplot(combined_with_inter_fun$gprofiler)
