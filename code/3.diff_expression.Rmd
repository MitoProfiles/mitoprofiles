...
## Differential expression | Combined TCGA and GTEx | Model WITHOUT interaction terms

```{r combined1, eval=TRUE}
...
## Differential expression | Combined TCGA and GTEx | Model WITH interaction terms


```{r combined, eval=TRUE}
