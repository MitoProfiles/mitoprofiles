...
```{r boxplots, dependson="degs_plot_function"}
...
hist(gtex_de$lrt$coefficients)
hist(tcga_de$lrt$coefficients)
hist(combined_de_no_interaction$lrt$coefficients)
hist(combined_de_only_interaction$lrt$coefficients)
hist(combined_de_with_interaction$lrt$coefficients)


# Visualize Log Fold Change values
hist(gtex_de$topGenes$table$logFC)
hist(tcga_de$topGenes$table$logFC)
hist(combined_de_no_interaction$topGenes$table$logFC)
hist(combined_de_only_interaction$topGenes$table$logFC)
hist(combined_de_with_interaction$topGenes$table$logFC)


# Visualize Log Counts per Million
hist(gtex_de$topGenes$table$logCPM)
hist(tcga_de$topGenes$table$logCPM)
hist(combined_de_no_interaction$topGenes$table$logCPM)
hist(combined_de_only_interaction$topGenes$table$logCPM)
hist(combined_de_with_interaction$topGenes$table$logCPM)
