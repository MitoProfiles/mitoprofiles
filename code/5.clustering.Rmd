...
pdf((file=here("analysis_output/heatmaps/heatmap_with_interaction.pdf")), width = 10.64, height = 8)  
## Heatmaps
...
for (page in 1:(num_clusters / clusters_per_page)) {
  ...
  my_mfuzz.plot2(ordered_dgelist_log2cpm, cl = sub_cmeans_res, mfrow = c(2, 2),
                 x11 = FALSE, xlab = "Samples",
                 centre = TRUE, centre.col = "gray10", centre.lwd = 0.1)
  dev.off()
}
