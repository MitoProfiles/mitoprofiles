...
```{r upregulated table, warning=FALSE}
...
write.csv(upregulated_df, here("analysis_output/upregulated_df.csv"), row.names=FALSE)

```



```{r downregulated table, warning=FALSE}
...
# Export the dataframe to a csv file
write.csv(downregulated_df, here("analysis_output/downregulated_df.csv"), row.names=FALSE)
```